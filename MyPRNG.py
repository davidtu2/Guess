...
MyPRNG.py:      Pseudo Random Number Generator(PRNG) Implementation: Generates random numbers and provides one if needed
    Input:      Integers of rseed, minimun and maximum
    Output:     A random number within the range [min max-1]
'''
...
class MyPRNG(object):
    ...
    def next_prn(self):
       return 16807 * self.z % 2147483647# Lehmer's PRNG formula: (a * z) % m
